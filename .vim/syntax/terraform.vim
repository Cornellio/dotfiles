...
"   syn case match
"
"   syn keyword terraSection connection output provider variable data
"   terraform
...
" " var.map["foo"]
" syn region terraValueVarSubscript
" start=/\(\<var\|\<module\)\.[a-z0-9_-]\+\[/ end=/\]/
" contains=terraValueString,terraValueFunction,terraValueVarSubscript
" contained
"
